    ...
    <div className="min-h-screen bg-bg text-text-primary">
      ...
      {view === 'home' && (
        <div className="animate-fade-in">
          {/* Header */}
          <header className="px-6 md:px-12 lg:px-20 pt-5 pb-4 flex items-center justify-between max-w-7xl mx-auto">
          ...
          {/* Hero */}
          <section className="px-6 md:px-12 lg:px-20 py-6 md:py-12 max-w-7xl mx-auto">
          ...
          {/* Service Categories */}
          <section className="px-6 md:px-12 lg:px-20 pb-10 max-w-7xl mx-auto">
          ...
          {/* Trust badges */}
          <section className="px-6 md:px-12 lg:px-20 pb-12 max-w-7xl mx-auto">
      ...
      {view === 'list' && (
        <div className="animate-fade-in">
          <header className="px-6 md:px-12 lg:px-20 pt-5 pb-4 flex items-center gap-3 max-w-7xl mx-auto">
          ...
          <div className="px-6 md:px-12 lg:px-20 pb-3 max-w-7xl mx-auto">
          ...
          <div className="px-6 md:px-12 lg:px-20 pb-10 max-w-7xl mx-auto space-y-4">
      ...
      {view === 'profile' && (
        <div className="animate-fade-in">
          <header className="px-6 md:px-12 lg:px-20 pt-5 pb-4 flex items-center gap-3 max-w-5xl mx-auto">
      ...
      {view === 'booking' && (
        <div className="animate-fade-in">
          ...
          {!bookingComplete ? (
            ...
            <div className="max-w-5xl mx-auto px-6 md:px-12 py-16 text-center animate-fade-in-up">
